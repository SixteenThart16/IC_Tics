...
def evaluar_respuestas():
    try:
        ...
        recomendacion_label.config(text="Recomendación: " + str(resultado))
...
indicaciones_label = tk.Label(root, text=indicaciones_texto, font=("Arial", 10), justify=tk.LEFT)
indicaciones_label.grid(row=2, column=1, pady=5) 
